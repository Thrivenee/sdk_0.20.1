...
pub fn contract_implementation(
    ...
    let main_definition = quote! {
        ...
        numbat_wasm::contract_base::ContractBase
        + Sized
        #(#supertraits_main)*
        where
        {
    ...
    let endpoint_wrappers = quote! {
            ...
            #(#endpoint_wrapper_supertrait_decl)*
        {
            ...
            fn callback_selector(&self, mut ___cb_closure___: numbat_wasm::types::CallbackClosureForDeser<Self::Api>) -> numbat_wasm::types::CallbackSelectorResult<Self::Api> {
    ...
    let wasm_endpoints = quote! {
        ...
        mod endpoints {
            ...
            fn new_andes_instance() -> super::ContractObj<numbat_wasm_node::ArwenApiImpl> {
                let api = numbat_wasm_node::ArwenApiImpl{};
