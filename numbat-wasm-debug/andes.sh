...
build_and_copy ./contracts/examples/crowdfunding-dcdt $ARWEN_PATH/test/crowdfunding-dcdt
build_and_copy ./contracts/examples/ping-pong-rewa $ARWEN_PATH/test/ping-pong-rewa
build_and_copy ./contracts/examples/multisig $ARWEN_PATH/test/multisig
build_and_copy ./contracts/examples/rewa-dcdt-swap $ARWEN_PATH/test/rewa-dcdt-swap
